...
- **DER completo** diseñado: 39 tablas PostgreSQL en 5 schemas lógicos, cobertura total del PBL (60/60 historias de usuario). Documento: `DER VIZTA — Documento Completo.md` en la raíz del workspace.
...
| Base de datos | **PostgreSQL** (única) | [[Conceptos/base-de-datos-unificada]] — consolida ambas MySQL; 39 tablas, 5 schemas |
...
├── DER VIZTA — Documento Completo.md ← diagrama entidad-relación (39 tablas PostgreSQL)
...
- [[Conceptos/diagrama-entidad-relacion]] — DER completo del modelo de datos (39 tablas)
...
- `C:\Users\eduar\OneDrive\Desktop\DelSud\Vizta\DER VIZTA — Documento Completo.md` — DER completo (39 tablas PostgreSQL)
